...
def get_events(db: Session = Depends(get_db)):
    ...
    # To compute registration_count, we could use subquery, but we can also just map
    result = []
    for event in events:
        ...
        ev_data["registration_count"] = count
...
def create_event(
    ...
    if not club or club.club_coordinator_id != current_user.id:
